// since this code is copied from Signup.jsx,the commented lines are removed from the code
...
const Signup = () => {
    ...
    async function onLogin(event){
        ...
        // as we have discussed we can do this without using form data
        //so lets see
    ...
    return (
        <HomeLayout>
            <div className="flex overflow-x-auto items-center justify-center h-[90vh]">
                <form noValidate onSubmit={onLogin} className="flex flex-col justify-center gap-3 p-4 w-96 text-white rounded-lg shadow-[0_0_10px_black]">
                    <h1 className="text-center font-bold text-2xl">Login <span className="text-indigo-600 font-bold text-3xl">In</span> !</h1>
                    ...
                    <p className="text-center">
                        Do not have an account? <Link to="/signup" className="link text-accent font-semibold cursor-pointer">Signup</Link>
                    </p>
                </form>
            </div>
        </HomeLayout>
